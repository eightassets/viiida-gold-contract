...
// Test that AuV operates correctly as an ERC20Basic token.
contract(
  "ERC20Basic AuV",
  function ([_, admin, recipient, anotherAccount, owner]) {
    ...
    describe("basic data", function () {
      it("has getters for the name, symbol, and decimals", async function () {
        ...
        assert.equal(name, "VIIIDA Gold");
        const symbol = await this.token.symbol();
        assert.equal(symbol, "AuV");
